...
class TvSeriesDetailNotifier extends ChangeNotifier {
  ...
  Future<void> addWatchlist(Map<String, dynamic> data) async {
  ...
  Future<void> removeFromWatchlist(int tvSeriesId) async {
    final result = await removeWatchlist.execute(tvSeriesId);
    ...
    await loadWatchlistStatus(tvSeriesId);
  }
