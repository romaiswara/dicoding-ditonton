...
class MovieRepositoryImpl implements MovieRepository {
  ...
  @override
  Future<Either<Failure, String>> saveWatchlistMovie(
  ...
  @override
  Future<Either<Failure, String>> removeWatchlistMovie(int movieId) async {
    try {
      final result = await localDataSource.removeWatchlist(movieId);
      return Right(result);
    } on DatabaseException catch (e) {
      return Left(DatabaseFailure(e.message));
    }
